...
class ClipSimilarity(nn.Module):
    ...
    def forward(
        ...
        temporal_sim0 = F.cosine_similarity(image_features_0[:-1],image_features_0[1:])
        temporal_sim1 = F.cosine_similarity(image_features_1[:-1],image_features_1[1:])
        return sim_0, sim_1, sim_direction, sim_image, temporal_sim0, temporal_sim1
